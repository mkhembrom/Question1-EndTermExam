...
public class Question1 {
	public static void main(String[] args){
		...
		case 1:
		{
			...
			//new ECE();
			System.out.println(new ECE().displayCourseDetails("ECE"));//call the function of the class that you initialized
			break;
		}
		case 2:
		{
			...
			System.out.println(new Mechanical().displayCourseDetails("Mechanical"));//call the function of the class that you initialized
			break;
		}
		case 3:
		{
			...
			//Initialize the Class using appropriately taking the concept of inheritence and polymorphism in mind.
			//Courses cse = new CSE();
			System.out.println(new CSE().displayCourseDetails("CSE"));//call the function of the class that you initialized
			break;
		}
		default:
